...
export const TABLE_HEADER_DATA = [
  ...
  { id: "TTT", title: "TTT", width: 400}
]

export const DEVICE_LIST = [
  { serialNumber: 'FACEFACE0001', name: 'a', ip: '192.168.0.1', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0002', name: 'b', ip: '192.168.0.2', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0003', name: 'c', ip: '192.168.0.3', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0004', name: 'd', ip: '192.168.0.4', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0005', name: 'e', ip: '192.168.0.5', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0006', name: 'f', ip: '192.168.0.6', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0007', name: 'g', ip: '192.168.0.7', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0008', name: 'h', ip: '192.168.0.8', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0009', name: 'i', ip: '192.168.0.9', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0010', name: 'j', ip: '192.168.0.10', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0011', name: 'k', ip: '192.168.0.11', TTT: "wtf, cool story" },
  { serialNumber: 'FACEFACE0012', name: 'l', ip: '192.168.0.12', TTT: "wtf, cool story" },
]

export const BIG_LIST = [
  ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST,
    ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, ...DEVICE_LIST, 
]
  ...
  const onSelect = useCallback(
    (selected, id) => {
      if (selected) {
        id !== undefined
          ? add(id)
          : reset(BIG_LIST.map(device => device.serialNumber))
      } else {
  ...
  return (
    <Wrapper>
      ...
      >
        <TableHeader
          selected={
            selection.size !== 0 && selection.size === BIG_LIST.length
          }
          partial={selection.size > 0 && selection.size < BIG_LIST.length}
          overlay={
        ...
        {BIG_LIST.map((device, index) => (
          ...
          >
            ...
            <Typography>{device.TTT}</Typography>
          </TableRow>
        ))}
      </Table>
    </Wrapper>
